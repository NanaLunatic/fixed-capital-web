...
import { setIsContentLarge } from "@/utils/cache/local-storage"
...
const handleContentLargeClick = () => {
  ...
  setIsContentLarge(isContentLarge.value)
  // 内容区放大时，将不需要的组件隐藏
...
<template>
  <div>
    <!-- 全屏 -->
    <el-tooltip v-if="!content" effect="dark-blue" :content="fullscreenTips" placement="bottom">
