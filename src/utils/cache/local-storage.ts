...
export const getUserInfo = () => {
  return localStorage.getItem(CacheKey.USER_INFO)
}
export const setUserInfo = (value: any) => {
  localStorage.setItem(CacheKey.USER_INFO, value)
}
//#endregion

//#region 内容区放大
export const getIsContentLarge = () => {
  return localStorage.getItem(CacheKey.IS_CONTENT_LARGE)
}
export const setIsContentLarge = (value: any) => {
  localStorage.setItem(CacheKey.IS_CONTENT_LARGE, value)
  // 监听localStorage变化
  const event = new Event("isContentLargeChanged")
